  ...
  return (
    ...
    <Paper sx={{ position: 'fixed', bottom: 0, left: 0, right: 0, backgroundColor: 'primary'}} elevation={3}>
      ...
      >
        ...
        style={{color: '#838383'}} 
        icon={<RiIcons.RiSendPlaneLine fontSize="24px" color="#838383"/>} component={Link} to="" />
        <BottomNavigationAction label="Alerts" 
        style={{color: '#838383'}} 
        icon={<BsIcons.BsBell fontSize="24px" color="#838383"/>} component={Link} to=""/>
        <BottomNavigationAction label="user" 
        style={{color: '#838383'}} 
        icon={<BiIcons.BiUser fontSize="24px" color="#838383" /> } component={Link} to=""/>
